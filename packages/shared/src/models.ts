...
export const SUPPORTED_CHAT_MODELS = [
  ...
  byok("openai", "gpt-5.2", { supportsVision: true, envKeys: ["OPENAI_API_KEY"], pricing: PRICING.openai.gpt5 }),
  byok("openai", "gpt-5.2-chat-latest", { supportsVision: true, envKeys: ["OPENAI_API_KEY"], pricing: PRICING.openai.gpt5 }),
  byok("openai", "gpt-5.1", { supportsVision: true, envKeys: ["OPENAI_API_KEY"], pricing: PRICING.openai.gpt5 }),
  byok("openai", "gpt-5.1-chat-latest", { supportsVision: true, envKeys: ["OPENAI_API_KEY"], pricing: PRICING.openai.gpt5 }),
  byok("openai", "gpt-5-codex", { envKeys: ["OPENAI_API_KEY"], pricing: PRICING.openai.gpt5 }),
  ...
  byok("groq", "qwen/qwen3.6-27b", { envKeys: ["GROQ_API_KEY"] }),
  byok("groq", "qwen/qwen3-32b", { envKeys: ["GROQ_API_KEY"] }),
  byok("groq", "groq/compound", { envKeys: ["GROQ_API_KEY"] }),
  byok("groq", "groq/compound-mini", { envKeys: ["GROQ_API_KEY"] }),

  byok("cerebras", "gpt-oss-120b", { envKeys: ["CEREBRAS_API_KEY"] }),
  byok("cerebras", "zai-glm-4.7", { envKeys: ["CEREBRAS_API_KEY"] }),
  ...
  byok("fireworks", "accounts/fireworks/models/gpt-oss-120b", { envKeys: ["FIREWORKS_API_KEY"] }),
  byok("fireworks", "accounts/fireworks/models/deepseek-v4-pro", { envKeys: ["FIREWORKS_API_KEY"] }),
  byok("fireworks", "accounts/fireworks/models/glm-5p2", { envKeys: ["FIREWORKS_API_KEY"] }),
  byok("fireworks", "accounts/fireworks/models/glm-5p1", { envKeys: ["FIREWORKS_API_KEY"] }),
  byok("fireworks", "accounts/fireworks/models/kimi-k2p6", { envKeys: ["FIREWORKS_API_KEY"] }),
  byok("fireworks", "accounts/fireworks/models/kimi-k2p5", { envKeys: ["FIREWORKS_API_KEY"] }),
  ...
  byok("nvidia", "deepseek-ai/deepseek-v4-pro", { envKeys: ["NVIDIA_API_KEY", "NVIDIA_NIM_API_KEY"] }),
  byok("nvidia", "deepseek-ai/deepseek-v4-flash", { envKeys: ["NVIDIA_API_KEY", "NVIDIA_NIM_API_KEY"] }),
  ...
  byok("nvidia", "meta/llama-4-maverick-17b-128e-instruct", { envKeys: ["NVIDIA_API_KEY", "NVIDIA_NIM_API_KEY"] }),
  ...
  byok("nvidia", "nvidia/llama-3.3-nemotron-super-49b-v1.5", { envKeys: ["NVIDIA_API_KEY", "NVIDIA_NIM_API_KEY"] }),
  byok("nvidia", "mistralai/mistral-medium-3.5-128b", { envKeys: ["NVIDIA_API_KEY", "NVIDIA_NIM_API_KEY"] }),
  ...
  byok("deepseek", "deepseek-v4-flash", { envKeys: ["DEEPSEEK_API_KEY"], pricing: PRICING.deepseek.chat }),
  byok("deepseek", "deepseek-v4-pro", { envKeys: ["DEEPSEEK_API_KEY"], pricing: PRICING.deepseek.reasoner }),
  ...
  byok("mistral", "mistral-medium-3-5", { envKeys: ["MISTRAL_API_KEY"], pricing: PRICING.mistral.medium }),
  ...
  byok("mistral", "devstral-latest", { envKeys: ["MISTRAL_API_KEY"], pricing: PRICING.mistral.codestral }),
  byok("mistral", "devstral-medium-latest", { envKeys: ["MISTRAL_API_KEY"], pricing: PRICING.mistral.medium }),
