...
const MCP_CATALOG: McpCatalogEntry[] = [
  ...
  {
    id: "n8n",
    label: "n8n Docs + Templates",
    description: "n8n node docs, templates, validation, and workflow design",
    ...npxServer("-y", "n8n-mcp"),
    needsKey: false,
  },
  {
    id: "n8n-api",
    label: "n8n Instance",
    description: "Create, validate, update, and inspect workflows in your n8n instance",
    ...npxServer("-y", "n8n-mcp"),
    env: { N8N_API_URL: "", N8N_API_KEY: "" },
    needsKey: true,
    setupUrl: "https://docs.n8n.io/api/",
  },
  {
    id: "telegram-bot",
    label: "Telegram Bot",
    description: "Send/read Telegram messages through a bot",
    ...npxServer("-y", "telegram-mcp-bot@latest"),
  ...
  },
  {
    id: "telegram",
    label: "Telegram User",
    description: "Full Telegram user-account access via MTProto",
    ...npxServer("-y", "mcp-telegram"),
    env: { TELEGRAM_API_ID: "", TELEGRAM_API_HASH: "" },
    needsKey: true,
    setupUrl: "https://my.telegram.org/apps",
  },
  {
    id: "notion",
    label: "Notion",
    description: "Search and manage Notion pages/databases",
    ...npxServer("-y", "@notionhq/notion-mcp-server"),
    env: { NOTION_TOKEN: "" },
    needsKey: true,
  ...
  },
  {
    id: "supabase",
    label: "Supabase",
    description: "Inspect and manage Supabase projects",
    ...npxServer("-y", "@supabase/mcp-server-supabase"),
  ...
  },
  {
    id: "stripe",
    label: "Stripe",
    description: "Inspect and manage Stripe resources",
    ...npxServer("-y", "@stripe/mcp"),
  ...
  },
  {
    id: "sentry",
    label: "Sentry",
    description: "Inspect Sentry issues, projects, and events",
    ...npxServer("-y", "@sentry/mcp-server"),
  ...
  },
  {
    ...
    ...npxServer("-y", "@modelcontextprotocol/server-gitlab"),
  ...
  },
  {
    id: "redis",
    label: "Redis",
    description: "Inspect and query Redis data",
    ...npxServer("-y", "@modelcontextprotocol/server-redis"),
    env: { REDIS_URL: "" },
    needsKey: true,
  },
  {
    id: "everart",
    label: "EverArt",
    description: "Generate images with EverArt",
    ...npxServer("-y", "@modelcontextprotocol/server-everart"),
    env: { EVERART_API_KEY: "" },
    needsKey: true,
    setupUrl: "https://www.everart.ai/",
  },
  {
    id: "docker",
    label: "Docker",
